...
- 프록시 패턴 : 클라이언트가 타깃에 접근하는 방법을 제어하기 위해
- 데코레이터 패턴 : 타깃에 부가적인 기능을 부여해주기 위해
...
- 한번에 여러개의 클래스에 공통적인 부가기능을 제공하는 건 불가능하다 (예를 들어 트랜잭션)
